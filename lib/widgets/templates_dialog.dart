                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    trailing: IconButton(
                      ...
                      onPressed: () {
                        // Confirm deletion
                        templateProvider.removeTemplate(item.id);
                      },
                    ),
                  );
                },
        ...
        content: Column(
          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(labelText: l10n.templateTitleHint),
            ),
            const SizedBox(height: 10),
            TextField(
              controller: contentController,
              decoration: InputDecoration(labelText: l10n.templateContentHint),
              maxLines: 3,
            ),
          ],
        ),
            ...
            onPressed: () {
              if (titleController.text.isNotEmpty && contentController.text.isNotEmpty) {
                Provider.of<TemplateProvider>(context, listen: false)
                    .addTemplate(titleController.text, contentController.text);
                Navigator.pop(ctx);
              }
            },
          ),
